...
export default function HeroPage() {
  return (
    <div id='home' className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2 flex justify-center lg:justify-end">
          <div className="relative">
            <div className="w-80 h-80 sm:w-96 sm:h-96 rounded-full bg-gradient-to-r from-blue-300 to-blue-500 shadow-2xl flex items-center justify-center">
              <img src={myImage} alt="Sai Chakradhar" className="rounded-full w-72 h-72 sm:w-88 sm:h-88 object-cover border-4 border-white" />
            </div>
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-white py-2 px-6 rounded-full shadow-lg text-center">
